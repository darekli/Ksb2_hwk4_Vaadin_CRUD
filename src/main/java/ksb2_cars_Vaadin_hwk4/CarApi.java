...
import java.util.Optional;
    ...
    public class CarApi {
        ...
        @GetMapping("{id}")
        public ResponseEntity<Car> getVehiclesById(@PathVariable String id) {
        ...
        public ResponseEntity modVehicleElement(@PathVariable String id, @PathVariable String color) {
